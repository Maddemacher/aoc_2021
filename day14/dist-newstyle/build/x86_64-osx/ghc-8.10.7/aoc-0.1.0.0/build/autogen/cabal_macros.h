...
/* package mr-env-0.1.0.4 */
#ifndef VERSION_mr_env
#define VERSION_mr_env "0.1.0.4"
#endif /* VERSION_mr_env */
#ifndef MIN_VERSION_mr_env
#define MIN_VERSION_mr_env(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mr_env */
